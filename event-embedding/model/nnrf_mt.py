...
from tf.keras.layers import Input, Embedding, Dropout, Dense, Lambda, Multiply, Masking # Added tf (team1-change)
...
class MTRF(GenericModel):
    ...
    def __init__(self, n_word_vocab=50001, n_role_vocab=7, n_factors_emb=300, n_hidden=300, word_vocabulary=None, role_vocabulary=None, 
        ...
        super(MTRF, self).__init__(n_word_vocab, n_role_vocab, n_factors_emb, n_hidden, word_vocabulary, role_vocabulary, 
        ...
        tw_hidden = target_word_hidden(non_linearity, target_role, n_word_vocab, n_role_vocab, glorot_uniform(), n_hidden, n_hidden, 
            using_dropout=using_dropout, dropout_rate=dropout_rate)

        # target role hidden layer
        tr_hidden = target_role_hidden(non_linearity, target_word, n_word_vocab, n_role_vocab, glorot_uniform(), n_hidden, n_hidden, 
            using_dropout=using_dropout, dropout_rate=dropout_rate)
