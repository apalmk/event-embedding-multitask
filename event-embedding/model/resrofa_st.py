...
from tf.keras.layers import Input, Embedding, Dropout, Dense, Lambda, Multiply, Masking, Add # Added tf (team1-change)
...
from tf.keras.models import Model # Added tf (team1-change)
...
class NNRF_ResROFA(GenericModel):
